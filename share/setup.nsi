...
!define URL http://www.fury.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/fury.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\fury-qt.exe
...
OutFile fury-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    ...
    #Delete /REBOOTOK $INSTDIR\fury.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\fury-qt.exe
