...
private slots:
    ...
    void on_BuyFURY_clicked();
    void on_SellFURYBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputFURY_textChanged(const QString &arg1);
    ...
    QString BuyFURY(QString OrderType, double Quantity, double Rate);
    QString SellFURY(QString OrderType, double Quantity, double Rate);
